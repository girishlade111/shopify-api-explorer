...
export function MensSection() {
  return (
    <section className="py-24 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-neutral-900 to-neutral-800 -z-10"></div>
      
      <CategoryHero 
        title="Men's Collection FW24"
        description="Sophistication redefined through impeccable craftsmanship and timeless design"
      ...
      <div className="container-wide">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-8 flex flex-col items-center text-center transition-transform hover:scale-105 duration-300">
            ...
            <Link to="/all-products/men/tailoring" className="text-primary flex items-center font-medium hover:underline">
          ...
          <div className="bg-white p-8 flex flex-col items-center text-center transition-transform hover:scale-105 duration-300">
            ...
            <Link to="/all-products/men/casual" className="text-primary flex items-center font-medium hover:underline">
              Discover <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </div>
          ...
          <div className="bg-white p-8 flex flex-col items-center text-center transition-transform hover:scale-105 duration-300">
            ...
            <Link to="/all-products/men/accessories" className="text-primary flex items-center font-medium hover:underline">
              Discover <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <Link 
            to="/all-products/men" 
            className="inline-block bg-white text-primary px-8 py-3 uppercase text-sm tracking-wider hover:bg-primary hover:text-white transition-colors border border-primary"
          >
            View All Menswear
          </Link>
        </div>
