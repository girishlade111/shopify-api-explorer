    ...
    <section className="py-24 bg-light">
      <div className="container-wide">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <img 
              src="https://assets.armani.com/image/upload/v1728401835/ARMANI_RESTAURANT_FALL_WINTER_2024.jpg" 
              alt="Armani Restaurants" 
              className="w-full h-auto object-cover"
            />
          </div>
          
          <div className="lg:pl-12">
            <h2 className="text-4xl md:text-5xl font-serif mb-6">Armani Restaurants</h2>
            ...
            <Link 
              ...
              className="inline-block border border-primary text-primary px-8 py-3 uppercase text-sm tracking-widest hover:bg-primary hover:text-white transition-colors"
            >
              Discover Dining
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-24">
          <ServiceCard 
            ...
            description="Enjoy a personalized shopping experience with our dedicated stylists in a private suite." 
            image="https://assets.armani.com/image/upload/f_auto,q_auto,ar_4:5,w_768,c_lfill/Armani_Prive_Club_Milano_2"
            link="/services/private-shopping"
          />
          
          <ServiceCard 
            title="Armani Hotels" 
            description="Immerse yourself in ultimate luxury at our exclusive hotels in iconic destinations worldwide." 
          ...
          <ServiceCard 
            title="Armani Fiori" 
            description="Discover elegant floral arrangements that embody the Armani aesthetic for your home or special events." 
