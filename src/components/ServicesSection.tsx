  ...
  return <section className="py-24 bg-light">
      <div className="container-wide">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <img src="https://assets.armani.com/image/upload/v1728401835/ARMANI_RESTAURANT_FALL_WINTER_2024.jpg" alt="Armani Restaurants" className="w-full h-auto object-cover" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-24">
          ...
          <ServiceCard title="Armani Hotels" description="Immerse yourself in ultimate luxury at our exclusive hotels in iconic destinations worldwide." image="https://assets.armani.com/image/upload/f_auto,q_auto,ar_4:5,w_768,c_lfill/Armani-Hotel-Balcony" link="/services/hotels" />
          
          <ServiceCard title="Armani Fiori" description="Discover elegant floral arrangements that embody the Armani aesthetic for your home or special events." image="https://assets.armani.com/image/upload/v1727108228/Armani_Fiori_Floral_Collections_038.jpg" link="/services/fiori" />
        </div>
      </div>
    </section>;
}
